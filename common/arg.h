...
#define COMMON_ARG_PRESET_RUNTIME             "__PRESET_RUNTIME"
#define COMMON_ARG_PRESET_WORKER              "__PRESET_WORKER"
#define COMMON_ARG_PRESET_STRIX_GPU_RESIDENT  "__PRESET_STRIX_GPU_RESIDENT"
